(() => {
  ...
  function gridClick(e){const b=e.target.closest('[data-open-lab]');if(b){state.active=b.dataset.openLab;save();renderAll();setTimeout(()=>$('#mesa')?.scrollIntoView({behavior:'smooth',block:'start'}),0);}else renderGrid();}
